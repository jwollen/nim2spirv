...
type
  ...
  SpvFPRoundingMode* {.size: sizeof(uint32).} = enum
  ...
  SpvLoopControlShift* {.size: sizeof(uint32).} = enum
  ...
  SpvFunctionControlShift* {.size: sizeof(uint32).} = enum
  ...
  SpvMemorySemanticsShift* {.size: sizeof(uint32).} = enum
  ...
  SpvKernelEnqueueFlags* {.size: sizeof(uint32).} = enum
    ...
    SpvKernelEnqueueFlagsWaitWorkGroup = 1
  ...
  SpvCapability* {.size: sizeof(uint32).} = enum
